...
%start plik
%token UND NOWALINIA
%token <ival> CALKOWITA SZESNASTKOWA INDEX
...
wiersz:  NOWALINIA
|       INDEX calkowita NOWALINIA {printf("%d %d\n", $1, $2); }
|       INDEX szesnastkowa NOWALINIA {printf("%d %#x\n", $1, $2); }
|       INDEX staloprzecinkowa NOWALINIA {printf("%d %f\n", $1, $2); }
|       INDEX zmiennoprzecinkowa NOWALINIA {printf("%d %E\n", $1, $2); };
